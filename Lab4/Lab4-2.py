...
class Car:
    ...
    # метод класса который будет каждый раз выводить ID+1 при создании объекта (решил ниже жестко прописать для этого примера id )
    # @classmethod
    ...
    # Создадим метод класса для вывода заданной марки авто (не понял почему не могу в вывод добавить color price..  )
    @classmethod
...
Car(1, "toyota", "auris", 2017, "red", 12000)
Car(2, "mazda", "cx-5", 2020, "black", 22000)
Car(3, "toyota", "Corolla ", 2018, "red", 21000)
Car(4, "mazda", "cx-5", 2018, "white", 21000)
Car(5, "toyota", "Camry ", 2016, "green", 14000)
Car(6, "mazda", "cx-5", 2015, "blue", 16000)
Car(7, "toyota", "Highlander", 2020, "blue", 28000)
Car(8, "mazda", "cx-5", 2020, "grey", 22000)
Car(9, "toyota", "RAV4", 2019, "black", 22000)
Car(10, "mazda", "cx-5", 2017, "blue", 18000)
Car(11, "toyota", "Land Cruiser Prado", 2019, "black", 30000)
Car(12, "mazda", "cx-5", 2019, "white", 20000)

# Вывод по марке
Car.print_list_brand("toyota")

# Вывод по модели и сроку эксплуатации
Car.print_list_model_years_old("cx-5", 4)

car1 = Car(1, "toyota", "auris", 2017, "red", 12000)
car2 = Car(2, "mazda", "cx-5", 2020, "blue", 22000)
...
# посчитаем скидку
print(f" price with discount {Car.customer_discount(car1.price)}")
...
print(f" price with discount {Car.customer_discount(car2.price)}")
